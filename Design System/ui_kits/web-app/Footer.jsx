...
const Footer = () => (
    <footer className="boltz-footer">
        <div className="socials">
            <a href="#" title="Github"><FooterIcon d={ICONS.github} /></a>
            <a href="#" title="Twitter"><FooterIcon d={ICONS.twitter} /></a>
            <a href="#" title="Nostr"><img src="../../assets/icons/nostr.svg" alt="" style={{ width: 22, height: 22 }} /></a>
            <a href="#" title="Substack"><img src="../../assets/icons/substack.svg" alt="" style={{ width: 22, height: 22 }} /></a>
            <a href="#" title="Youtube"><FooterIcon d={ICONS.youtube} /></a>
            <a href="#" title="Email"><FooterIcon d={ICONS.email} /></a>
        </div>
        <p className="footer-nav">
            <a href="#">Partner</a> | <a href="#">Branding</a> | <a href="#">Status</a> | <a href="#">Regtest</a> | <a href="#">Onion</a>
        </p>
        <p className="legal-nav">
            <a href="#">Terms</a><a href="#">Privacy</a>
        </p>
        <p className="version">Version: 2.1.2, Commit Hash: a1b2c3d</p>
        <p className="made">Made with 🧡 by Team Boltz</p>
    </footer>
);
